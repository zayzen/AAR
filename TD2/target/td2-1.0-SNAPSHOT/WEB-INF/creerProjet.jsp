...
<form action="/ctrl" method="post">
    ...
    <select name = "choixCompetences" multiple="multiple">
        <c:forEach items="${competencesProjet}" var="competence">
            <option value="${competence.intituleC}">${competence.intituleC}</option>
        </c:forEach>
    </select>
    <!--<input type="hidden" value="inscription" name="action"/>-->
    <button type="submit" value="creerProjet" name="action"> Valider </button>
